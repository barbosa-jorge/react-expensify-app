import { removeExpense, addExpense, editExpense, startAddExpense, setExpenses, startSetExpenses } from '../../actions/expenses'
...
test('shoudl fetch the expenses from firebase', ()=>{
    const store = createMockStore();
